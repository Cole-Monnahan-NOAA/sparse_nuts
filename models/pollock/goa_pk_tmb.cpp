...
// Added more priors for sparse NUTS testing
...
Type objective_function<Type>::operator() ()
{
  ...
  RMSE_srv4=0;
    ...
    loglik(23) += dnorm(inf2_srv1, Type(10.0),Type(1.5), true);
    loglik(23) += dnorm(inf1_srv2, Type(5),Type(3), true);
    loglik(23) += dnorm(log_slp2_srv1, Type(0),Type(1.0), true);
    loglik(23) += dnorm(log_slp1_srv2, Type(0),Type(4.0), true);
    loglik(23) += dnorm(log_slp2_fsh_mean, Type(0),Type(1.0), true);
